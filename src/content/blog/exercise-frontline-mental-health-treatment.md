...
tags: ["exercise", "depression", "anxiety", "daily-practices", "mental-health"]
author: "Florecer Mind Research Team"

sources:
  - title: "Singh et al. (2023). Effectiveness of physical activity interventions for improving depression, anxiety and distress: an overview of systematic reviews. British Journal of Sports Medicine, 57(18), 1203–1209."
    url: "https://doi.org/10.1136/bjsports-2022-106195"
    type: "study"
  - title: "Schuch et al. (2016). Exercise as a treatment for depression: A meta-analysis adjusting for publication bias. Journal of Psychiatric Research, 77, 42–51."
...
furtherReading:
  - title: "WHO Physical Activity Fact Sheet"
    ...
    description: "Global guidelines on how much movement supports physical and mental health"
  - title: "Spark: The Revolutionary New Science of Exercise and the Brain by John Ratey"
    url: "https://www.hachettebookgroup.com/titles/john-j-ratey/spark/9780316113519/"
    description: "An accessible tour of how movement changes the brain"
...
**1. Shrink the first rep until it's laughable.**
The goal on a bad day is not a workout—it's *putting on your shoes and stepping outside.* Depression attacks initiation, not capacity. Make the entry point so small that "I don't have the energy" stops being a valid excuse. Momentum, not willpower, does the rest.

**2. Favor moderate aerobic movement.**
Walking briskly, cycling, swimming, dancing. The strongest antidepressant evidence sits with moderate-intensity aerobic exercise (Schuch et al., 2016). "Moderate" means you can talk but not sing.

**3. Aim for consistency over volume.**
Short and frequent beats rare and heroic. Programs under 12 weeks worked as well as longer ones—so this week matters more than your yearly plan. A daily 15-minute walk is a real dose.

**4. Borrow structure and company.**
Supervised programs showed the largest effects, partly because they solve the initiation problem for you. A scheduled class, a walking friend, or an appointment on the calendar externalizes the motivation you can't summon internally.

**5. Notice the calmer nervous system, not the scale.**
Track how you sleep, how reactive you feel, how heavy the morning is—not weight or pace. Those are the outcomes the research is actually about.
...
1. **Put on your shoes and walk for ten minutes**—today, before the reasons not to arrive
2. **Schedule three walks** into your calendar this week, at fixed times, like appointments
3. **Find one person** to move with, or one class to show up to, so the structure isn't all on you
4. **Track your mornings** for two weeks—not your weight—and watch what movement does to them
